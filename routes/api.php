...
Route::middleware(['auth:sanctum', 'userRole:1'])->prefix('super-admin')->group(function () {
    ...
    Route::put('inv-header/detail/{inv_no}', [SuperAdminInvHeaderController::class, 'getInvHeaderDetail']);
    Route::post('inv-header/{inv_no}/upload-payment', [SuperAdminInvHeaderController::class, 'uploadPaymentDocument']);
...
Route::middleware(['auth:sanctum', 'userRole:2'])->prefix('finance')->group(function () {
    ...
    Route::put('inv-header/detail/{inv_no}', [FinanceInvHeaderController::class, 'getInvHeaderDetail']);
    Route::post('inv-header/{inv_no}/upload-payment', [FinanceInvHeaderController::class, 'uploadPaymentDocument']);
