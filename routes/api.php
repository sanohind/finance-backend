...
Route::middleware(['auth:sanctum', 'userRole:2'])->prefix('finance')->group(function () {
    ...
    Route::post('inv-header/upload-payment', [FinanceInvHeaderController::class, 'uploadPaymentDocument']);
    Route::put('inv-header/revert/{inv_no}', [FinanceInvHeaderController::class, 'revertToReadyToPayment']);
